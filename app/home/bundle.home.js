...
/***/ function(module, exports, __webpack_require__) {
	...
	var asyncTest = function () {
	    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
	        var apiKey, gameServer, response;
	            ...
	            while (1) {
	                switch (_context.prev = _context.next) {
	                    case 0:
	                        ...
	                        gameServer = 'euw';
	                        _context.next = 4;
	                        return fetch('https://global.api.pvp.net/api/lol/static-data/' + gameServer + '/v1.2/realm?api_key=' + apiKey);
	...
	var _locker = __webpack_require__(323);

	var locker = _interopRequireWildcard(_locker);

	var _cachemanager = __webpack_require__(324);

	var cacheManager = _interopRequireWildcard(_cachemanager);

	var _api = __webpack_require__(326);

	var api = _interopRequireWildcard(_api);

	var _spectator = __webpack_require__(327);
	...
	var ipc = __webpack_require__(328).ipcRenderer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-39589755&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./app.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-39589755&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./app.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n#global[_v-39589755] {\n    width: 100vw;\n    height: 100vh;\n}\n\n.loadingscreen-enter[_v-39589755] {\n    opacity: 0;\n    -webkit-transform: scale(0.6);\n            transform: scale(0.6);\n}\n\n.loadingscreen-enter-active[_v-39589755], .loadingscreen-leave-active[_v-39589755] {\n    -webkit-transform: scale(0.8);\n            transform: scale(0.8);\n}\n\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apikeymodal = __webpack_require__(317);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-dc77bf4a&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./home.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-dc77bf4a&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./home.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.newsummonername-enter[_v-dc77bf4a], .newsummonername-leave-active[_v-dc77bf4a] {\n    -webkit-transform: translate(0, 100%);\n            transform: translate(0, 100%)\n}\n\n.newsummonername-enter-active[_v-dc77bf4a], .newsummonername-leave[_v-dc77bf4a] {\n    -webkit-transform: translate(0, 0%);\n            transform: translate(0, 0%)\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div id=\"home-page\" class=\"home-page\" _v-dc77bf4a=\"\">\n\n    <transition name=\"newsummonername\" _v-dc77bf4a=\"\">\n        <input class=\"new-summoner-name\" placeholder=\"new name\" v-model=\"newSummonerName\" v-if=\"changeNameInputVisible\" v-on:keypress.enter=\"setNewSummonerName()\" _v-dc77bf4a=\"\">\n    </transition>\n    \n\n    <div class=\"summoner-name\" v-on:dblclick=\"toggleChangeNameInputVisibility()\" _v-dc77bf4a=\"\">\n        {{ global.summonername }}\n    </div>\n\n    <div class=\"launch-game-button\" v-bind:class=\"[global.searchingGame || changeNameInputVisible ? 'active' : '']\" v-on:click=\"global.waitForGame()\" _v-dc77bf4a=\"\">\n        spectate\n    </div>\n\n    <div class=\"app-state\" v-bind:text-content=\"'appState'\" _v-dc77bf4a=\"\">\n    </div>\n\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-117a0af0/loading.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-3983557c/apikeymodal.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-3983557c&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./apikeymodal.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-3983557c&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./apikeymodal.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div id=\"apiKey-input\" class=\"apiKey-input\" _v-3983557c=\"\">\n\n    <div _v-3983557c=\"\"> The API Key you're using is invalid or inexistant </div>\n    \n    <input placeholder=\"enter your api key here\" v-model=\"newApiKey\" v-on:keypress.enter=\"setNewApiKey()\" _v-3983557c=\"\">\n\n</div>\n";

/***/ },
/* 322 */
/***/ function(module, exports) {

	module.exports = "\n<div id=\"global\" _v-39589755=\"\">\n\n    <comp-home-page :global=\"global\" _v-39589755=\"\">\n    </comp-home-page>\n\n    <transition name=\"loadingscreen\" _v-39589755=\"\">\n        <comp-loading-screen v-if=\"global.loadingScreenVisible\" :global=\"global\" _v-39589755=\"\">\n        </comp-loading-screen>\n    </transition>\n\n    <comp-require-apikey :global=\"global\" v-if=\" isApiKeyInvalid() \" _v-39589755=\"\">\n\n    </comp-require-apikey>\n\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _riotInformations = __webpack_require__(325);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getSummonerData = exports.getSummonerData = function getSummonerData(apiKey, summonerName) {
	    return new Promise(function (resolve, reject) {
	        ...
	        var formatedSummonerName = summonerName.toLowerCase().split(' ').join('');
